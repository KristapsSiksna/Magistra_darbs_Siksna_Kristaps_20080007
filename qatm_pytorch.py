...
# -----original path ---------------
#template_dir = 'QATM_pytorch/template_original'
#image_path = 'QATM_pytorch/sample/sample1.jpg'
# dataset = ImageDataset(Path(template_dir), image_path)

# -------------my path-------------------
template_dir = 'FITS_images/template'
image_path = 'FITS_images/sample/p045.jpg'
#image_path = 'FITS_images/sample/sample2.jpg'
dataset = ImageDataset(Path(template_dir), image_path)
...
prof.dump_stats('qatm_pytorch.stats')

with open('qatm_pytorch_output.txt', 'wt') as output:
    stats = Stats('qatm_pytorch.stats', stream=output)
    stats.sort_stats('cumulative', 'time')
    stats.print_stats()
    prof.dump_stats("qatm_pytorch.prof")
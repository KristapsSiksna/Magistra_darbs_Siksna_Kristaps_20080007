...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--template_images_dir', default='FITS_images/aaaaa')
    # parser.add_argument('-s', '--sample_image', default='sample/sample1.jpg')
    # parser.add_argument('-t', '--template_images_dir', default='Templates/')
    ...
    x = plot_result_multi(dataset.image_raw, boxes, indices, show=False, save_name='result.png')
    plt.imshow(x)
    plt.show()
